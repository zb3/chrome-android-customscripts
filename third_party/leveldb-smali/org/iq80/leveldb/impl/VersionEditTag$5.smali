.class final enum Lorg/iq80/leveldb/impl/VersionEditTag$5;
...
.method public readValue(Lorg/iq80/leveldb/util/SliceInput;Lorg/iq80/leveldb/impl/VersionEdit;)V
    ...
    invoke-virtual {p2, v0, v1}, Lorg/iq80/leveldb/impl/VersionEdit;->setLastSequenceNumber(J)V
...
.method public writeValue(Lorg/iq80/leveldb/util/SliceOutput;Lorg/iq80/leveldb/impl/VersionEdit;)V
    ...
    .prologue
    .line 125
    invoke-virtual {p2}, Lorg/iq80/leveldb/impl/VersionEdit;->getLastSequenceNumber()Ljava/lang/Long;

    move-result-object v0

    .line 126
    .local v0, "lastSequenceNumber":Ljava/lang/Long;
    if-eqz v0, :cond_0

    .line 127
    invoke-virtual {p0}, Lorg/iq80/leveldb/impl/VersionEditTag$5;->getPersistentId()I
