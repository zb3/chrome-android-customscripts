.class final enum Lorg/iq80/leveldb/impl/VersionEditTag$2;
...
.method public readValue(Lorg/iq80/leveldb/util/SliceInput;Lorg/iq80/leveldb/impl/VersionEdit;)V
    ...
    invoke-virtual {p2, v0, v1}, Lorg/iq80/leveldb/impl/VersionEdit;->setLogNumber(J)V
...
.method public writeValue(Lorg/iq80/leveldb/util/SliceOutput;Lorg/iq80/leveldb/impl/VersionEdit;)V
    ...
    .prologue
    .line 67
    invoke-virtual {p2}, Lorg/iq80/leveldb/impl/VersionEdit;->getLogNumber()Ljava/lang/Long;

    move-result-object v0

    .line 68
    .local v0, "logNumber":Ljava/lang/Long;
    if-eqz v0, :cond_0

    .line 69
    invoke-virtual {p0}, Lorg/iq80/leveldb/impl/VersionEditTag$2;->getPersistentId()I
